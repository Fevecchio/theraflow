...
> **Aviso:** Este documento é um rascunho para revisão jurídica. Antes de publicar para usuários reais, submeta a um advogado especializado em direito digital e LGPD.
...
- Módulo financeiro e controle de cobranças
...
a) Ser profissional de saúde mental habilitado, com registro ativo no Conselho Federal de Psicologia (CFP) ou conselho de classe equivalente;
b) Ter capacidade legal para contratar, nos termos do Código Civil Brasileiro;
c) Utilizar a Plataforma exclusivamente para fins profissionais lícitos;
d) Manter suas informações cadastrais atualizadas e verdadeiras.

---

## 4. Conta e Segurança

4.1. Você é responsável por manter a confidencialidade de suas credenciais de acesso.
...
a) Utilizar a Plataforma para fins ilegais ou que violem direitos de terceiros;
b) Compartilhar sua conta com outros profissionais sem plano multi-usuário contratado;
...
## 6. Responsabilidades do Terapeuta

6.1. **Consentimento do paciente.** O Terapeuta é o responsável legal por obter o consentimento informado do paciente para coleta, armazenamento e uso dos seus dados clínicos, conforme exigido pela LGPD (Lei 13.709/2018) e pela Resolução CFP 04/2020.

6.2. **Prontuário.** O Terapeuta é responsável pela completude, veracidade e guarda dos registros clínicos inseridos na Plataforma, conforme as normas do CFP.

6.3. **Julgamento clínico.** Toda sugestão gerada pela inteligência artificial da Plataforma é auxiliar. A decisão clínica final é sempre e exclusivamente do profissional.

6.4. **Gravação de sessões.** Quando disponível, o recurso de gravação de sessões somente deve ser utilizado com consentimento explícito e registrado do paciente, conforme legislação vigente.

6.5. **Uso ético.** O Terapeuta se compromete a utilizar a Plataforma em conformidade com o Código de Ética Profissional do Psicólogo e demais normas do CFP.

---

## 7. Planos e Pagamentos

7.1. **Trial gratuito.** Novos usuários têm direito a um período de avaliação gratuita de 20 sessões. Após esse limite, é necessária a contratação de um plano pago para continuar utilizando a Plataforma.

7.2. **Planos pagos.** Os planos, valores e condições estão disponíveis na página de preços da Plataforma e podem ser alterados mediante aviso prévio de 30 dias.

7.3. **Cobrança.** As cobranças são realizadas de forma recorrente (mensal ou anual, conforme o plano contratado) via cartão de crédito processado pelo Stripe.
...
Estes Termos são regidos pelas leis da República Federativa do Brasil. Fica eleito o foro da Comarca de **[CIDADE/ESTADO]** para dirimir quaisquer controvérsias, com renúncia a qualquer outro, por mais privilegiado que seja.
