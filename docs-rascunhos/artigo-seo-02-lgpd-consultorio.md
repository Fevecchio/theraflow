# [ARTIGO SEO 2 — RASCUNHO COMPLETO] LGPD para psicólogos: o guia prático do consultório (sem juridiquês)

**Palavra-chave alvo:** "LGPD psicólogo consultório"
**Título SEO:** LGPD para Psicólogos: o que muda no seu consultório (guia prático 2026)
**Meta descrição:** Quais dados você pode tratar, com qual base legal, por quanto tempo guardar e o que fazer com WhatsApp, prontuário digital e gravações. Guia direto para psicólogas(os).
**Slug sugerido:** /blog/lgpd-psicologo-consultorio

> Notas p/ revisão do fundador: tom "colega experiente", zero terrorismo ético — a LGPD aqui é aliada do sigilo que a profissão já pratica. Conferir citações dos artigos antes de publicar. Linkar /seguranca no ponto marcado. CTA usa o kit "Consultório em Dia" (kit-01/02/03 desta pasta).

---

A cena é comum: você atende há anos com ética e sigilo impecáveis, mas na primeira vez que um paciente pergunta "meus dados estão protegidos conforme a LGPD?", vem o frio na barriga. A boa notícia: **você não precisa virar advogada(o) — precisa de cinco decisões bem tomadas.** A LGPD, no fundo, pede formalização daquilo que a psicologia já faz por dever ético desde sempre: proteger o que o paciente confia a você.
